...
# Clean data
df = df[df["value"].between( df["value"].quantile(0.25),df["value"].quantile(0.975))]
months = ['January','February','March','April','May','June','July','August','September','October','November','December']

def draw_line_plot():
  fig, ax=plt.subplts(figsize=(15,5))
  ax = sns.lineplot(data=df,lenegd="brief")
...
def draw_box_plot():
    ...
    fig, ax = plt.subplts(1,2,figsize=(16,6))
    sns.bosplot(y="value",x='year',data=df_box, ax =ax[0])
